\begin{theo}[Nonlinear Programming (NLP)]{NLP}
...
\begin{theo}[Linear Programming (LP)]{LP}
...
\begin{theo}[Quadratic Programming (QP)]{QP}
...
\begin{theo}[Mixed-Integer Programming (MIP)]{MIP}
